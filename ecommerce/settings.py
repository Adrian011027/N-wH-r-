...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,192.168.1.73,192.168.1.68,.ngrok.io,.ngrok-free.app,nowheremx.com,www.nowheremx.com,3.138.41.66', cast=lambda v: [s.strip() for s in v.split(',')])
