...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function crearFilaTalla() {
    ...
    row.innerHTML = `
      <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 100px; gap: 12px; align-items: end; margin-bottom: 12px;">
        <label>
          Color
          <input type="text" name="colores" placeholder="Ej. Negro" value="N/A" />
        </label>
        <label>
          Talla
