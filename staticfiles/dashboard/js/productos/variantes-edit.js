    ...
    newVarianteCard.innerHTML = `
      ...
      <div class="variante-fields-full">
        <div class="variante-field">
          <label>Talla</label>
          <input type="text" name="variante_talla_${tempId}" 
                 placeholder="Ej: 38, M, L, XL" required>
        </div>
        ...
        <div class="variante-field">
          <label>Stock</label>
          <input type="number" name="variante_stock_${tempId}" min="0" required>
        </div>
      </div>
      ...
      <div class="variante-gallery" data-variante-id="${tempId}">
        ...
        <div class="variante-gallery-grid">
          ...
          <div class="var-upload-area">
            <input type="file" class="var-image-input" data-variante-id="${tempId}" accept="image/*" />
